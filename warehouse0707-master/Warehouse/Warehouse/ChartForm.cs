                ...
                try
                {
                    ...
                    if (id.Equals("") == false)
                    {
                        ...
                        else
                        {
                            ...
                            string sql = "select * from [bindata] where [BinID] = " + id 
                                + " and [DateTime]>='" + time_start.ToString("yyyy/MM/dd HH:mm:ss")
                                + "' and [DateTime]<='" + time_end.ToString("yyyy/MM/dd HH:mm:ss") + "'  order by [DateTime] asc";
                            DataBase db = new DataBase();
                            db.command.CommandText = sql;
                            db.command.Connection = db.connection;
                            ...
                            while (db.Dr.Read())
                            {
                                ...
                                {
                                    if (db.Dr["Volume"].ToString().Equals("-1"))
                                        continue;
